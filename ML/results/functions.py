...
clik_guests = widgets.Checkbox(value=False, description='Guest included', disabled=False)
...
clik_zip_code = widgets.Select(description='Zip code:', options=zip_code, disabled=False, rows=14, layout=Layout(width='auto'))
...
clik_bathrooms = widgets.IntSlider(description='Bathrooms:', value=1, min=1, max=5, style=style)
clik_accommodates = widgets.IntSlider(description='Accommodates:', value=1, min=1, max=5, style=style)
...
def formularz():
    ...
    left_box = widgets.VBox([clik_month, box_inside_left, clik_room])
    #left_box = widgets.VBox([clik_zip_code, clik_month, clik_room, clik_property])
    right_box = widgets.VBox([clik_guests, clik_extra_people, clik_cleaning, clik_superhost, clik_accommodates, clik_beds, clik_bedrooms, clik_bathrooms])
...
def click_button_moj(button_moj):
    ...
    print(f'accommodates: {clik_accommodates.value}, bathrooms: {clik_bathrooms.value}, bedrooms: {clik_bedrooms.value}, beds: {clik_beds.value}')
